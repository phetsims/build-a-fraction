 ...
 * please modify build-a-fraction/package.json to control dependencies.
 *
 * RequireJS configuration file for the build-a-fraction sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'build-a-fraction-main' ],
